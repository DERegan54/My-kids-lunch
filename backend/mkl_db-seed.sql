...
VALUES ('Ham Sandwich', 'ham and cheese sandwich on wheat bread with an apple, baby carrots, oreos, and gatorade','ham', 'wheat bread', 'apple', 'baby carrots', 'american cheese', 'oreos', 'gatorade'),
       ...
       ('Yogurt Parfait', 'Plain yogurt, granola and blueberries layered in a cup with water, cucumbers and ginger snaps')
       ('Turkey Sandwich', 'Turkey with mayonnaise on rye bread with a banana, green bell peppers, fruit gummies and iced tea')
